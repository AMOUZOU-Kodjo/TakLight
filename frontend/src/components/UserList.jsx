      ...
      <div className="p-3 border-b border-gray-200 dark:border-gray-700">
        <div className="relative">
          ...
          <input
            ...
            className="w-full pl-9 pr-3 py-2 bg-gray-100 dark:bg-gray-700 rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-primary-500 dark:text-gray-200 dark:placeholder-gray-400"
          />
        </div>
      </div>
            ...
            {users.map((u) => (
              ...
              >
                ...
                <div className="flex-1 min-w-0">
                  ...
                  {u.bio && <p className="text-xs text-gray-500 dark:text-gray-400 truncate">{u.bio}</p>}
                </div>
              </button>
            ))}
            {loading && (
